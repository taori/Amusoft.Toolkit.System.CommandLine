...
public class BindHandlerCodeFixProvider : CodeFixProvider
{
	...
	private bool TryGetConstructor(SyntaxNode? syntaxTree, Diagnostic diagnostic, CancellationToken token, [NotNullWhen(true)]out ConstructorDeclarationSyntax? constructor)
	{
		constructor = default;
